...
function displayData(data){
    ...
    for(let i = 0; i<10; i++){
        ...
        document.getElementById(`name${i+1}`).textContent = data[i].name
        document.getElementById(`email${i+1}`).textContent = data[i].email
        document.getElementById(`username${i+1}`).textContent = data[i].username
